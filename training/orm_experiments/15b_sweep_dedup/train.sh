...
export WANDB_PROJECT="codeprm-orm-15b-sweep-dedup"
export WANDB_NAME="sweep_starcoder2_15b_orm_raw50_dedup_${GRAD_ACC}_${LR}"
OUTDIR="/dev/shm/model_starcoder2_15b_orm_raw50_dedup_${GRAD_ACC}_${LR}"
